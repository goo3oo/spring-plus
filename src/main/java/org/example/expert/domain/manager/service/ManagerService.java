...
import org.example.expert.domain.manager.log.LogService;
...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(CustomUserDetails userDetails, long todoId, ManagerSaveRequest managerSaveRequest) {
        try {
            ...
            logService.saveLog(todoId, userDetails.getId(), managerSaveRequest.getManagerUserId(), "SUCCESS");
            ...
            logService.saveLog(todoId, userDetails.getId(), managerSaveRequest.getManagerUserId(), "FAIL");
            throw e;
        }
    }
